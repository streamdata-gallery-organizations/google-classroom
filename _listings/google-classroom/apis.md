...
- name: Google Classroom API
  description: Google Classroom is mission control for your classes
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/google-classroom.png
  humanURL: ""
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-classroom/master/_listings/google-classroom/v1-userprofiles-userid-get.md
x-common:
- type: x-button
